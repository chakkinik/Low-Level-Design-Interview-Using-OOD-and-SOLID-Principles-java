...
The game should detect and announce the winner or a draw at the end of the game.
    ...
    public static void main(String[] args) {
        ...
        /*
          ...
          Board is getting init with 3*3 square with blank

          Board decide which player will have turn and next turn.

          Board verify after each turn is there is winner or not.
